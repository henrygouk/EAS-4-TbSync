    ...
    getOAuthObj: function (configObject = null) {
        ...
        oauth.asyncConnect = async function (rv) {
            ...
            try {
                ...
                await oauth.setToken("accessToken", oauth.getToken("accessToken"));
                await oauth.setToken("refreshToken", oauth.getToken("refreshToken"));
                await oauth.setToken("tokenExpires", oauth.getToken("tokenExpires"));
